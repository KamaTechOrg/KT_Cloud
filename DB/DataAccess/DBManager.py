...
class DBManager:
    ...
    def select(self, table_name: str, columns: List[str] = ['*'], criteria: str = '') -> Dict[Any, Dict[str, Any]]:
        ...
        Returns:
            Dict[Any, Dict[str, Any]]: A dictionary where keys are object_ids and values are metadata.
        '''
